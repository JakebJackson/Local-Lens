...
var saveBtn = document.getElementById('saved-btn');


// Function for Local Storage - Job
function storedJob() {
  var savedJob = document.getElementById('saved-job');

  var job = savedJob.textContent;

  localStorage.setItem("job", JSON.stringify(job));
}

// Function for Local Storage - URL
function storedArticleURL() {
  var savedArticleURL = document.getElementById('saved-article-url');

  var articleURL = savedArticleURL.textContent;

  localStorage.setItem("articleURL", JSON.stringify(articleURL));
}


// Function for Local Storage - Date Published
function storedArticleDatePublished() {
  var savedArticlePublished = document.getElementById('saved-article-date-published');

  var articleDate = savedArticlePublished.textContent;

  localStorage.setItem("articleDatePublished", JSON.stringify(articleDate));
}